...
CREATE TABLE `level_system` (
  `idLevel_System` int NOT NULL AUTO_INCREMENT,
  `Current_Experience` bigint NOT NULL,
  `Next_Level` bigint NOT NULL,
  `id_User_Details` int NOT NULL,
  PRIMARY KEY (`idLevel_System`),
  UNIQUE KEY `idLevel_System_UNIQUE` (`idLevel_System`),
  KEY `User_Details_Level_sys_idx` (`id_User_Details`),
  CONSTRAINT `User_Details_Level_sys` FOREIGN KEY (`id_User_Details`) REFERENCES `user_details` (`id_user_details`)
